...
public final class Constants {
    ...
    public static final double MAX_SPEED_MOD = .2; //set a moddifer for max speed.
    ...
    public static final double FRONT_LEFT_MODULE_STEER_OFFSET = -Math.toRadians(309.111); // FIXME Measure and set front left steer offset
    ...
    public static final double FRONT_RIGHT_MODULE_STEER_OFFSET = -Math.toRadians(103.35); // FIXME Measure and set front right steer offset
    ...
    public static final double BACK_LEFT_MODULE_STEER_OFFSET = -Math.toRadians(242.25468750000002); // FIXME Measure and set back left steer offset
    ...
    public static final double BACK_RIGHT_MODULE_STEER_OFFSET = -Math.toRadians(239.15); // FIXME Measure and set back right steer offset
}
